        ...
        <div className="p-2">
          ...
          <div className="max-h-72 overflow-y-auto">
            ...
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2 hover:bg-gray-50 rounded-lg text-sm text-gray-700 transition-colors"
            >
              <TicketCheck size={16} className="text-gray-500" />
              Các khuyến mãi
            </Link>
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 hover:bg-red-50 hover:cursor-pointer rounded-lg text-sm text-red-600 transition-colors group/btn"
          >
            <LogOut
              size={16}
